...
static std::initializer_list< std::string > tests = {
    ...
    "player_triggered",
    "potion_dislocation_bad_luck",
    "potion_dislocation_good_luck",
    "potion_healing",
    "potion_levitation_player_chasm",
    "potion_levitation_player_grass",
    "potion_levitation_player_in_steam",
    "potion_levitation_player_lava",
    "potion_levitation_player_move_fail",
    "potion_levitation_player_move_fail2",
    "potion_levitation_player_on_fire",
    "potion_levitation_player_rubble",
    "potion_levitation_player_spiderweb",
    ...
    "throw_item_at_monst",
    "throw_item_chasm",
    "throw_item_potion_dislocation",
    "throw_item_potion_healing_into_lava",
    "throw_item_potion_healing",
    "throw_item_potion_incin_chain_explosion",
    "throw_item_potion_incin_chasm",
    "throw_item_potion_incin_into_water",
    "throw_item_potion_incin",
    "throw_item_potion_levitation_hard_landing",
    "throw_item_potion_levitation_soft_landing",
