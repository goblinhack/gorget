...
static std::initializer_list< std::string > tests = {
    ...
    "player_triggered",
    "pot_dislocn_bad_luck",
    "pot_dislocn_good_luck",
    "pot_healing",
    "pot_lev_player_chasm",
    "pot_lev_player_grass",
    "pot_lev_player_in_steam",
    "pot_lev_player_lava",
    "pot_lev_player_move_fail",
    "pot_lev_player_move_fail2",
    "pot_lev_player_on_fire",
    "pot_lev_player_rubble",
    "pot_lev_player_spiderweb",
    "pot_lev_player_water",
    "pot_lev_trampled_grass",
    "pot_prot",
    "pot_stealth",
    "pot_tireless",
    ...
    "throw_item_pot_lev_hard_landing",
    "throw_item_pot_lev_soft_landing",
    "throw_item_pot_lev",
    "throw_item_pot_monst_can_move",
    "throw_item_pot_monst_cannot_move",
    "throw_item_pot_monst_death",
    "throw_items",
    "trampled_grass",
    "wall",
    "weapon_discharge",
