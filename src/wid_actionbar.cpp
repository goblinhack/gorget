...
#endif
    wid_set_text(w, "%%fg=orange$" + ::to_string(game_key_wait_get(g)) + "%%fg=white$" + " Wait");
...
#endif
    wid_set_text(w, "%%fg=orange$" + ::to_string(game_key_load_get(g)) + "%%fg=white$" + " Load");
    wid_set_mode(g, w, WID_MODE_OVER);
    wid_set_style(w, box_highlight_style);
    wid_set_mode(g, w, WID_MODE_NORMAL);
    wid_set_style(w, box_style);
...
#endif
    wid_set_text(w, "%%fg=orange$" + ::to_string(game_key_save_get(g)) + "%%fg=white$" + " Save");
    wid_set_mode(g, w, WID_MODE_OVER);
    wid_set_style(w, box_highlight_style);
    wid_set_mode(g, w, WID_MODE_NORMAL);
    wid_set_style(w, box_style);
...
#endif
    wid_set_text(w, "%%fg=orange$" + ::to_string(game_key_quit_get(g)) + "%%fg=white$" + " Quit");
    wid_set_mode(g, w, WID_MODE_OVER);
    wid_set_style(w, box_highlight_style);
    wid_set_mode(g, w, WID_MODE_NORMAL);
    wid_set_style(w, box_style);
