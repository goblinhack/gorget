...
void level_fixed_add(Gamep, int chance, LevelType /*level_type*/, const std::string &alias, const char * /*file*/,
                     int line, Overrides /*overrides*/, ...);
[[nodiscard]] bool level_populate(Gamep, Levelsp, Levelp, class LevelGen * /*level_gen*/, const char * /*in*/,
                                  Overrides /*overrides*/ = no_overrides);
[[nodiscard]] bool level_populate(Gamep, Levelsp, Levelp, class LevelGen * /*level_gen*/, int w, int h,
