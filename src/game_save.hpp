...
std::ostream &operator<<(std::ostream &out, Bits< const class Game & > const my)
{
  ...
  // Save Thing offsets
  //
  serialized_size = offsetof(Thing, tp_id);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, dir);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, anim_index);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _priority);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, count);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _vision_distance);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _jump_distance);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _is_hit);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _is_hot);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, anim_type);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, level_num);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, tile_index);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, anim_ms_remaining);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _speed);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _temperature);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _damage_this_tick);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _keys_carried);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value1);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value2);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value3);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value4);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value5);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value6);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value7);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value8);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value9);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value10);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value11);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value12);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value13);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value14);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value15);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value16);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value17);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value18);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value19);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value20);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value21);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value22);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _value23);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _variant);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _lifespan);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _age);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _submerged_pct);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _health);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _is_falling_ms);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _weight);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, tick);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, tick_temperature);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, tick_temperature_last_change);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, iter);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, tick_dead);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, tick_teleport);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, id);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, owner_id);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, ai_id);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _prev_pix_at);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _curr_pix_at);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _moving_from);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, last_pushed_at);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, thing_dt);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, angle);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _old_at);
  out << bits(serialized_size);
  serialized_size = offsetof(Thing, _at);
  out << bits(serialized_size);

  //
  // Save Level offsets
  //
  serialized_size = offsetof(Level, level_num);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, info);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, level_select_at);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, entrance);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, exit);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, ts);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, last_ts);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, tick_temperature);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, level_num_next);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, _tile_update_required);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, thing_id);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, player_fov_has_seen_tile);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, player_has_walked_tile);
  out << bits(serialized_size);
  serialized_size = offsetof(Level, debug);
  out << bits(serialized_size);
