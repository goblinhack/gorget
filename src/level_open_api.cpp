...
{
  TRACE_DEBUG();
  return level_open(g, v, l, is_able_to_throw_items, p);
}
...
{
  TRACE_DEBUG();
  return level_open(g, v, l, is_unused_99, p);
}
...
{
  TRACE_DEBUG();
  return level_open(g, v, l, is_auto_wield, p);
}
...
{
  TRACE_DEBUG();
  return level_open(g, v, l, is_able_to_wield_items, p);
}
...
{
  TRACE_DEBUG();
  return level_open(g, v, l, is_argusul, p);
}
...
{
  TRACE_DEBUG();
  return level_open(g, v, l, is_skullferno, p);
}
