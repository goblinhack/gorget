...
#define THING_FLAG_ENUM(list_macro)                                                                                  \
  clang_format_indent()                                                 /* dummy line for clang indentation fixup */ \
      ...
      list_macro(is_blit_in_chasm, "is_blit_in_chasm"),                 /* newline */                                \
...
#define tp_is_blit_in_chasm(tp)         tp_flag(tp, is_blit_in_chasm)
...
#define level_afirst_is_blit_in_chasm(g, v, l, p)         level_afirst_flag(g, v, l, is_blit_in_chasm, p)
...
#define level_alive_is_blit_in_chasm(g, v, l, p)          level_alive_flag(g, v, l, is_blit_in_chasm, p)
...
#define level_count_is_blit_in_chasm(g, v, l, p)          level_count_flag(g, v, l, is_blit_in_chasm, p)
...
#define level_first_is_blit_in_chasm(g, v, l, p)          level_first_flag(g, v, l, is_blit_in_chasm, p)
...
#define level_is_blit_in_chasm(g, v, l, p)                level_flag(g, v, l, is_blit_in_chasm, p)
...
#define level_open_is_blit_in_chasm(g, v, l, p)           level_open_flag(g, v, l, is_blit_in_chasm, p)
