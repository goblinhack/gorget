...
bool tp_is_is_cursor_path_hazard(Tpp tp);
void tp_is_is_cursor_path_hazard_set(Tpp tp, bool val);

bool tp_is_is_cursor_path_blocker(Tpp tp);
void tp_is_is_cursor_path_blocker_set(Tpp tp, bool val);

bool tp_is_is_obs_wall_or_door(Tpp tp);
void tp_is_is_obs_wall_or_door_set(Tpp tp, bool val);

bool tp_is_able_to_walk_through_walls(Tpp tp);
void tp_is_able_to_walk_through_walls_set(Tpp tp, bool val);
