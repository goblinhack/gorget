...
#define THING_FLAG_ENUM(list_macro)                                                                                  \
  clang_format_indent()                                                 /* dummy line for clang indentation fixup */ \
      ...
      list_macro(is_obs_to_falling, "is_obs_to_falling"),               /* newline */                                \
      list_macro(is_obs_to_fire, "is_obs_to_fire"),                     /* newline */                                \
      list_macro(is_obs_to_jump_landing, "is_obs_to_jump_landing"),     /* newline */                                \
...
#define tp_is_obs_to_falling(tp)        tp_flag(tp, is_obs_to_falling)
...
#define level_is_obs_to_falling(g, v, l, p)        level_flag(g, v, l, is_obs_to_falling, p)
...
#define level_afirst_is_monst_group_0(g, v, l, p)         level_afirst_flag(g, v, l, is_monst_group_0, p)
#define level_afirst_is_monst_group_1(g, v, l, p)         level_afirst_flag(g, v, l, is_monst_group_1, p)
#define level_afirst_is_monst_group_2(g, v, l, p)         level_afirst_flag(g, v, l, is_monst_group_2, p)
...
#define level_afirst_is_unused20(g, v, l, p)              level_afirst_flag(g, v, l, is_unused20, p)
...
#define level_afirst_is_unused8(g, v, l, p)               level_afirst_flag(g, v, l, is_unused8, p)
#define level_afirst_is_unused9(g, v, l, p)               level_afirst_flag(g, v, l, is_unused9, p)
