...
[[nodiscard]] std::string tp_short_name(Tpp tp);
void                      tp_short_name_set(Tpp tp, const std::string &val);

[[nodiscard]] std::string tp_long_name(Tpp tp);
void                      tp_long_name_set(Tpp tp, const std::string &val);

[[nodiscard]] std::string tp_pluralize_name(Tpp tp);
void                      tp_pluralize_name_set(Tpp tp, const std::string &val);

[[nodiscard]] std::string tp_apostrophize_name(Tpp tp);
void                      tp_apostrophize_name_set(Tpp tp, const std::string &val);

[[nodiscard]] std::string tp_real_name(Tpp tp);
...
[[nodiscard]] color tp_light_color(Tpp tp);

[[nodiscard]] int   tp_tiles_size(Tpp tp, ThingAnim val);
[[nodiscard]] Tilep tp_first_tile(class Tp *tp, ThingAnim val);
...
[[nodiscard]] TpId tp_id_get(Tpp tp);
[[nodiscard]] Tpp  tp_find(TpId id);
[[nodiscard]] Tpp  tp_find_mand(const std::string &val);
[[nodiscard]] Tpp  tp_find_opt(const std::string &val);

[[nodiscard]] Tpp string2tp(const char **s, int *len = nullptr);
[[nodiscard]] Tpp tp_load(const std::string &val);
...
[[nodiscard]] uint8_t tp_z_depth_get(Tpp tp);

void              tp_speed_set(Tpp tp, int val);
[[nodiscard]] int tp_speed_get(Tpp tp);

void              tp_health_set(Tpp tp, const std::string &val);
[[nodiscard]] int tp_health_get(Tpp tp);
[[nodiscard]] int tp_health_max_get(Tpp tp);

void              tp_temperature_initial_set(Tpp tp, int val);
[[nodiscard]] int tp_temperature_initial_get(Tpp tp);

void              tp_temperature_burns_at_set(Tpp tp, int val);
[[nodiscard]] int tp_temperature_burns_at_get(Tpp tp);

void              tp_temperature_melts_at_set(Tpp tp, int val);
[[nodiscard]] int tp_temperature_melts_at_get(Tpp tp);

void              tp_temperature_damage_at_set(Tpp tp, int val);
[[nodiscard]] int tp_temperature_damage_at_get(Tpp tp);
...
[[nodiscard]] int tp_weight_get(Tpp tp);

void                tp_temperature_thermal_conductivity_set(Tpp tp, float val);
[[nodiscard]] float tp_temperature_thermal_conductivity_get(Tpp tp);

void                tp_temperature_heat_capacity_set(Tpp tp, float val);
[[nodiscard]] float tp_temperature_heat_capacity_get(Tpp tp);

void              tp_value1_set(Tpp tp, int val);
[[nodiscard]] int tp_value1_get(Tpp tp);

void              tp_value2_set(Tpp tp, int val);
[[nodiscard]] int tp_value2_get(Tpp tp);

void              tp_value3_set(Tpp tp, int val);
[[nodiscard]] int tp_value3_get(Tpp tp);

void              tp_value4_set(Tpp tp, int val);
[[nodiscard]] int tp_value4_get(Tpp tp);

void              tp_value5_set(Tpp tp, int val);
[[nodiscard]] int tp_value5_get(Tpp tp);

void              tp_value6_set(Tpp tp, int val);
[[nodiscard]] int tp_value6_get(Tpp tp);

void              tp_value7_set(Tpp tp, int val);
[[nodiscard]] int tp_value7_get(Tpp tp);

void              tp_value8_set(Tpp tp, int val);
[[nodiscard]] int tp_value8_get(Tpp tp);

void              tp_value9_set(Tpp tp, int val);
[[nodiscard]] int tp_value9_get(Tpp tp);

void              tp_value10_set(Tpp tp, int val);
[[nodiscard]] int tp_value10_get(Tpp tp);

void              tp_value11_set(Tpp tp, int val);
[[nodiscard]] int tp_value11_get(Tpp tp);

void              tp_value12_set(Tpp tp, int val);
[[nodiscard]] int tp_value12_get(Tpp tp);

void              tp_value13_set(Tpp tp, int val);
[[nodiscard]] int tp_value13_get(Tpp tp);

void              tp_value14_set(Tpp tp, int val);
[[nodiscard]] int tp_value14_get(Tpp tp);

void              tp_value15_set(Tpp tp, int val);
[[nodiscard]] int tp_value15_get(Tpp tp);

void              tp_value16_set(Tpp tp, int val);
[[nodiscard]] int tp_value16_get(Tpp tp);

void              tp_value17_set(Tpp tp, int val);
[[nodiscard]] int tp_value17_get(Tpp tp);

void              tp_value18_set(Tpp tp, int val);
[[nodiscard]] int tp_value18_get(Tpp tp);

void              tp_value19_set(Tpp tp, int val);
[[nodiscard]] int tp_value19_get(Tpp tp);

void              tp_value20_set(Tpp tp, int val);
[[nodiscard]] int tp_value20_get(Tpp tp);

void              tp_minion_max_set(Tpp tp, int val);
[[nodiscard]] int tp_minion_max_get(Tpp tp);

void              tp_distance_minion_from_mob_max_set(Tpp tp, int val);
[[nodiscard]] int tp_distance_minion_from_mob_max_get(Tpp tp);

void              tp_distance_vision_set(Tpp tp, int val);
[[nodiscard]] int tp_distance_vision_get(Tpp tp);

void              tp_variant_set(Tpp tp, int val);
[[nodiscard]] int tp_variant_get(Tpp tp);
...
[[nodiscard]] int tp_distance_jump_get(Tpp tp);

void              tp_lifespan_set(Tpp tp, const std::string &val);
[[nodiscard]] int tp_lifespan_get(Tpp tp);
[[nodiscard]] int tp_lifespan_max_get(Tpp tp);

void               tp_is_immunity_add(Tpp tp, ThingEventType val);
[[nodiscard]] bool tp_is_immune_to(Tpp tp, ThingEventType val);

void tp_monst_group_add(Tpp tp, ThingMonstGroup val);

[[nodiscard]] float tp_collision_radius(Tpp t);
...
#define tp_is_able_to_fall_repeatedly(tp)     tp_flag(tp, is_able_to_fall_repeatedly)
...
#define tp_is_blit_per_pixel_lighting(tp)     tp_flag(tp, is_blit_per_pixel_lighting)
...
#define tp_is_border(tp)                      tp_flag(tp, is_border)
...
#define tp_is_collision_detection_enabled(tp) tp_flag(tp, is_collision_detection_enabled)
...
#define tp_is_flesh(tp)                       tp_flag(tp, is_flesh)
...
#define tp_is_insectoid(tp)                   tp_flag(tp, is_insectoid)
...
#define tp_is_mob_kill_minions_on_death(tp)   tp_flag(tp, is_mob_kill_minions_on_death)
...
#define tp_is_obs_to_spawning(tp)             tp_flag(tp, is_obs_to_spawning)
#define tp_is_obs_to_teleporting_onto(tp)     tp_flag(tp, is_obs_to_teleporting_onto)
...
#define tp_is_plant(tp)                       tp_flag(tp, is_plant)
#define tp_is_player(tp)                      tp_flag(tp, is_player)
#define tp_is_projectile(tp)                  tp_flag(tp, is_projectile)
#define tp_is_removable_on_err(tp)            tp_flag(tp, is_removable_on_err)
#define tp_is_removable_when_dead_on_err(tp)  tp_flag(tp, is_removable_when_dead_on_err)
...
#define tp_is_stone(tp)                       tp_flag(tp, is_stone)
...
#define level_is_able_to_fall_repeatedly(g, v, l, p)     level_flag(g, v, l, is_able_to_fall_repeatedly, p)
...
#define level_is_blit_per_pixel_lighting(g, v, l, p)     level_flag(g, v, l, is_blit_per_pixel_lighting, p)
...
#define level_is_border(g, v, l, p)                      level_flag(g, v, l, is_border, p)
...
#define level_is_collision_detection_enabled(g, v, l, p) level_flag(g, v, l, is_collision_detection_enabled, p)
...
#define level_is_flesh(g, v, l, p)                       level_flag(g, v, l, is_flesh, p)
...
#define level_is_insectoid(g, v, l, p)                   level_flag(g, v, l, is_insectoid, p)
...
#define level_is_mob_kill_minions_on_death(g, v, l, p)   level_flag(g, v, l, is_mob_kill_minions_on_death, p)
...
#define level_is_obs_to_spawning(g, v, l, p)             level_flag(g, v, l, is_obs_to_spawning, p)
#define level_is_obs_to_teleporting_onto(g, v, l, p)     level_flag(g, v, l, is_obs_to_teleporting_onto, p)
...
#define level_is_plant(g, v, l, p)                       level_flag(g, v, l, is_plant, p)
...
#define level_is_removable_on_err(g, v, l, p)            level_flag(g, v, l, is_removable_on_err, p)
#define level_is_removable_when_dead_on_err(g, v, l, p)  level_flag(g, v, l, is_removable_when_dead_on_err, p)
...
#define level_is_stone(g, v, l, p)                       level_flag(g, v, l, is_stone, p)
...
#define level_alive_is_able_to_fall_repeatedly(g, v, l, p)     level_alive(g, v, l, is_able_to_fall_repeatedly, p)
...
#define level_alive_is_blit_per_pixel_lighting(g, v, l, p)     level_alive(g, v, l, is_blit_per_pixel_lighting, p)
...
#define level_alive_is_border(g, v, l, p)                      level_alive(g, v, l, is_border, p)
...
#define level_alive_is_collision_detection_enabled(g, v, l, p) level_alive(g, v, l, is_collision_detection_enabled, p)
...
#define level_alive_is_flesh(g, v, l, p)                       level_alive(g, v, l, is_flesh, p)
...
#define level_alive_is_insectoid(g, v, l, p)                   level_alive(g, v, l, is_insectoid, p)
...
#define level_alive_is_mob_kill_minions_on_death(g, v, l, p)   level_alive(g, v, l, is_mob_kill_minions_on_death, p)
...
#define level_alive_is_obs_to_spawning(g, v, l, p)             level_alive(g, v, l, is_obs_to_spawning, p)
#define level_alive_is_obs_to_teleporting_onto(g, v, l, p)     level_alive(g, v, l, is_obs_to_teleporting_onto, p)
...
#define level_alive_is_plant(g, v, l, p)                       level_alive(g, v, l, is_plant, p)
...
#define level_alive_is_removable_on_err(g, v, l, p)            level_alive(g, v, l, is_removable_on_err, p)
#define level_alive_is_removable_when_dead_on_err(g, v, l, p)  level_alive(g, v, l, is_removable_when_dead_on_err, p)
...
#define level_alive_is_stone(g, v, l, p)                       level_alive(g, v, l, is_stone, p)
...
#define level_count_is_able_to_fall_repeatedly(g, v, l, p)     level_count(g, v, l, is_able_to_fall_repeatedly, p)
...
#define level_count_is_blit_per_pixel_lighting(g, v, l, p)     level_count(g, v, l, is_blit_per_pixel_lighting, p)
...
#define level_count_is_border(g, v, l, p)                      level_count(g, v, l, is_border, p)
...
#define level_count_is_collision_detection_enabled(g, v, l, p) level_count(g, v, l, is_collision_detection_enabled, p)
...
#define level_count_is_flesh(g, v, l, p)                       level_count(g, v, l, is_flesh, p)
...
#define level_count_is_insectoid(g, v, l, p)                   level_count(g, v, l, is_insectoid, p)
...
#define level_count_is_mob_kill_minions_on_death(g, v, l, p)   level_count(g, v, l, is_mob_kill_minions_on_death, p)
...
#define level_count_is_obs_to_spawning(g, v, l, p)             level_count(g, v, l, is_obs_to_spawning, p)
#define level_count_is_obs_to_teleporting_onto(g, v, l, p)     level_count(g, v, l, is_obs_to_teleporting_onto, p)
...
#define level_count_is_plant(g, v, l, p)                       level_count(g, v, l, is_plant, p)
...
#define level_count_is_removable_on_err(g, v, l, p)            level_count(g, v, l, is_removable_on_err, p)
#define level_count_is_removable_when_dead_on_err(g, v, l, p)  level_count(g, v, l, is_removable_when_dead_on_err, p)
...
#define level_count_is_stone(g, v, l, p)                       level_count(g, v, l, is_stone, p)
...
#define level_open_is_able_to_fall_repeatedly(g, v, l, p)     level_open(g, v, l, is_able_to_fall_repeatedly, p)
...
#define level_open_is_blit_per_pixel_lighting(g, v, l, p)     level_open(g, v, l, is_blit_per_pixel_lighting, p)
...
#define level_open_is_border(g, v, l, p)                      level_open(g, v, l, is_border, p)
...
#define level_open_is_collision_detection_enabled(g, v, l, p) level_open(g, v, l, is_collision_detection_enabled, p)
...
#define level_open_is_flesh(g, v, l, p)                       level_open(g, v, l, is_flesh, p)
...
#define level_open_is_insectoid(g, v, l, p)                   level_open(g, v, l, is_insectoid, p)
...
#define level_open_is_mob_kill_minions_on_death(g, v, l, p)   level_open(g, v, l, is_mob_kill_minions_on_death, p)
...
#define level_open_is_obs_to_spawning(g, v, l, p)             level_open(g, v, l, is_obs_to_spawning, p)
#define level_open_is_obs_to_teleporting_onto(g, v, l, p)     level_open(g, v, l, is_obs_to_teleporting_onto, p)
...
#define level_open_is_plant(g, v, l, p)                       level_open(g, v, l, is_plant, p)
...
#define level_open_is_removable_on_err(g, v, l, p)            level_open(g, v, l, is_removable_on_err, p)
#define level_open_is_removable_when_dead_on_err(g, v, l, p)  level_open(g, v, l, is_removable_when_dead_on_err, p)
...
#define level_open_is_stone(g, v, l, p)                       level_open(g, v, l, is_stone, p)
