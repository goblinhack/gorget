...
int      thing_pix_x_get(Thingp t) { return t->pix_x; }
int      thing_pix_y_get(Thingp t) { return t->pix_y; }
int      thing_speed_get(Thingp t) { return t->speed; }
...
void     thing_pix_x_set(Thingp t, int pix_x) { t->pix_x = pix_x; }
void     thing_pix_y_set(Thingp t, int pix_y) { t->pix_y = pix_y; }
void     thing_speed_set(Thingp t, int speed) { t->speed = speed; }
