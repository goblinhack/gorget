...
static void tp_player_level_populated(Gamep g, Levelsp v, Levelp l, Thingp t) { TRACE_INDENT(); }

static void tp_player_tick_begin(Gamep g, Levelsp v, Levelp l, Thingp t) { TRACE_INDENT(); }
