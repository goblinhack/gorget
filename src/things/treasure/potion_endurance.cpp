...
static auto tp_potion_endurance_description_get(Gamep g, Levelsp v, Levelp l, Thingp t) -> std::string
{
  TRACE();
...
static auto tp_potion_endurance_detail_get(Gamep g, Levelsp v, Levelp l, Thingp t) -> std::string
{
  TRACE();
...
[[nodiscard]] static auto tp_potion_endurance_on_carry_request(Gamep g, Levelsp v, Levelp l, Thingp t, Thingp collector) -> bool
{
  TRACE();
...
[[nodiscard]] static auto tp_potion_endurance_on_drop_request(Gamep g, Levelsp v, Levelp l, Thingp t, Thingp dropper) -> bool
{
  TRACE();
...
[[nodiscard]] static auto tp_potion_endurance_on_carry_success(Gamep g, Levelsp v, Levelp l, Thingp t, Thingp collector) -> bool
{
  TRACE();
...
[[nodiscard]] static auto tp_potion_endurance_on_drop_success(Gamep g, Levelsp v, Levelp l, Thingp t, Thingp dropper) -> bool
{
  TRACE();
...
static void tp_potion_endurance_on_thrown(Gamep g, Levelsp v, Levelp l, Thingp t, Thingp thrower)
{
  TRACE();
...
static bool tp_potion_endurance_on_use(Gamep g, Levelsp v, Levelp l, Thingp t, Thingp user)
{
  TRACE();
...
static void tp_potion_endurance_on_death(Gamep g, Levelsp v, Levelp l, Thingp t, ThingEvent &e)
{
  TRACE();
...
[[nodiscard]] auto tp_load_potion_endurance() -> bool
{
  ...
  thing_on_carry_request_set(tp, tp_potion_endurance_on_carry_request);
  thing_on_carry_success_set(tp, tp_potion_endurance_on_carry_success);
