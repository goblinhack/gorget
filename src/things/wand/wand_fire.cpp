...
[[nodiscard]] static auto tp_wand_fire_on_drop_request(Gamep g, Levelsp v, Levelp l, Thingp me, Thingp dropper, ThingEvent &e) -> bool
{
  TRACE();
...
[[nodiscard]] static auto tp_wand_fire_on_carry_success(Gamep g, Levelsp v, Levelp l, Thingp me, Thingp collector, ThingEvent &e) -> bool
{
  TRACE();
...
[[nodiscard]] static auto tp_wand_fire_on_drop_success(Gamep g, Levelsp v, Levelp l, Thingp me, Thingp dropper, ThingEvent &e) -> bool
{
  TRACE();
...
[[nodiscard]] static auto tp_wand_fire_on_wield_request(Gamep g, Levelsp v, Levelp l, Thingp me, Thingp user) -> bool
{
  TRACE();
