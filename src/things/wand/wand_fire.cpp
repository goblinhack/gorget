...
static auto tp_wand_fire_description_get(Gamep g, Levelsp v, Levelp l, Thingp t) -> std::string
{
  TRACE();
...
static auto tp_wand_fire_detail_get(Gamep g, Levelsp v, Levelp l, Thingp t) -> std::string
{
  TRACE();
...
[[nodiscard]] static auto tp_wand_fire_on_wield_request(Gamep g, Levelsp v, Levelp l, Thingp t, Thingp user) -> bool
{
  TRACE();
