...
static auto tp_potion_protection_description_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  TRACE();
...
static auto tp_potion_protection_detail_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  TRACE();
...
static void tp_potion_protection_on_thrown_end(Gamep g, Levelsp v, Levelp l, Thingp me, Thingp thrower)
{
  TRACE();
...
static bool tp_potion_protection_on_use(Gamep g, Levelsp v, Levelp l, Thingp me, Thingp user)
{
  TRACE();
...
static void tp_potion_protection_on_death(Gamep g, Levelsp v, Levelp l, Thingp me, ThingEvent &e)
{
  TRACE();
...
[[nodiscard]] auto tp_load_potion_protection() -> bool
{
  TRACE();

  auto *tp   = tp_load("potion_protection"); // keep as string for scripts
  auto  name = tp_name(tp);

  // begin sort marker1 {
  thing_description_set(tp, tp_potion_protection_description_get);
  thing_detail_set(tp, tp_potion_protection_detail_get);
  thing_on_death_set(tp, tp_potion_protection_on_death);
  thing_on_thrown_end_set(tp, tp_potion_protection_on_thrown_end);
  ...
  tp_name_short_set(tp, "potion, protection");
