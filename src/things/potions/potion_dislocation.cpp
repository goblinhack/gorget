...
static auto tp_potion_dislocation_description_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  TRACE();
...
static auto tp_potion_dislocation_detail_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  TRACE();
...
static bool tp_potion_dislocation_on_use(Gamep g, Levelsp v, Levelp l, Thingp me, Thingp user)
{
  TRACE();
...
static void tp_potion_dislocation_on_death(Gamep g, Levelsp v, Levelp l, Thingp me, ThingEvent &e)
{
  TRACE();
...
[[nodiscard]] auto tp_load_potion_dislocation() -> bool
{
  TRACE();

  auto *tp   = tp_load("potion_dislocation"); // keep as string for scripts
  auto  name = tp_name(tp);

  // begin sort marker1 {
  thing_description_set(tp, tp_potion_dislocation_description_get);
  thing_detail_set(tp, tp_potion_dislocation_detail_get);
  thing_on_death_set(tp, tp_potion_dislocation_on_death);
  thing_on_thrown_end_set(tp, tp_potion_dislocation_on_thrown_end);
  ...
  tp_name_short_set(tp, "potion, dislocation");
