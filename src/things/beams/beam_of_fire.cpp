...
[[nodiscard]] auto tp_load_beam_of_fire() -> bool
{
  ...
  tp_name_a_or_an_set(tp, "a beam_weapon weapon of fire");
  tp_name_apostrophize_set(tp, "beam_weapon weapon of fire's");
  tp_name_long_set(tp, "beam_weapon weapon of fire");
  tp_name_pluralize_set(tp, "beams of fire");
  tp_name_short_set(tp, "fire beam_weapon weapon");
