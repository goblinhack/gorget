...
auto level_is_able_to_open_things(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
...
auto level_is_able_to_be_equipped(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
...
auto level_is_flat(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
