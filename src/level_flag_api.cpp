...
auto level_is_effect_attack(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_effect_attack, p);
}

auto level_is_effect_blood(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
...
auto level_is_hit_when_dead(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
...
auto level_is_able_to_see_180_degrees(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_able_to_see_180_degrees, p);
}

auto level_is_able_to_lunge(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
