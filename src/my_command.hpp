...
auto               command_fini() -> void;
[[nodiscard]] auto command_init() -> bool;
auto               command_add(Gamep g, command_fn_t callback, const std::string &input, const std::string &readable_input) -> void;
