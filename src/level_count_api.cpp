...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_able_to_teleport, p);
}
...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_unused157, p);
}
...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_unused187, p);
}
...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_able_to_levitate, p);
}
