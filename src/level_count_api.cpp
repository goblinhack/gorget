...
auto level_count_is_attackable_by_player(Gamep g, Levelsp v, Levelp l, const spoint &p) -> uint32_t
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_attackable_by_player, p);
}

auto level_count_is_attackable_by_monst(Gamep g, Levelsp v, Levelp l, const spoint &p) -> uint32_t
{
  TRACE_DEBUG();
...
auto level_count_is_grouped_thing(Gamep g, Levelsp v, Levelp l, const spoint &p) -> uint32_t
{
  TRACE_DEBUG();
...
auto level_count_is_obs_to_paths(Gamep g, Levelsp v, Levelp l, const spoint &p) -> uint32_t
{
  TRACE_DEBUG();
