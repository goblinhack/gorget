...
void wid_move_delta_pct(Gamep, Widp, double dx, double dy);
...
void wid_move_to_horiz_pct(Gamep, Widp w, double pct);
void wid_move_to_left(Gamep, Widp);
void wid_move_to_pct_centered(Gamep, Widp, double dx, double dy);
void wid_move_to_pct(Gamep, Widp, double dx, double dy);
void wid_move_to_right(Gamep, Widp);
void wid_move_to_top(Gamep, Widp);
void wid_move_to_vert_pct(Gamep, Widp w, double pct);
...
void wid_set_on_destroy_begin(Gamep, Widp, on_destroy_begin_t fn);
void wid_set_on_destroy(Gamep, Widp, on_destroy_t fn);
void wid_set_on_display(Gamep, Widp, on_display_t fn);
void wid_set_on_joy_button(Gamep, Widp, on_joy_button_t fn);
void wid_set_on_key_down(Gamep, Widp, on_key_down_t fn);
void wid_set_on_key_up(Gamep, Widp, on_key_up_t fn);
void wid_set_on_mouse_down(Gamep, Widp, on_mouse_down_t fn);
void wid_set_on_mouse_focus_begin(Gamep, Widp, on_mouse_focus_begin_t fn);
void wid_set_on_mouse_focus_end(Gamep, Widp, on_mouse_focus_end_t fn);
void wid_set_on_mouse_held(Gamep, Widp, on_mouse_down_t fn);
void wid_set_on_mouse_motion(Gamep, Widp, on_mouse_motion_t fn);
void wid_set_on_mouse_over_begin(Gamep, Widp, on_mouse_over_begin_t fn);
