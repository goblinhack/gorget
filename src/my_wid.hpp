...
[[nodiscard]] Widp wid_new_container(Gamep /*g*/, Widp /*parent*/, std::string name);
[[nodiscard]] Widp wid_new_horiz_scroll_bar(Gamep /*g*/, Widp parent, std::string name, Widp scrollbar_owner);
[[nodiscard]] Widp wid_new_plain(Gamep /*g*/, Widp parent, std::string name);
[[nodiscard]] Widp wid_new_square_button(Gamep /*g*/, Widp parent, std::string name);
[[nodiscard]] Widp wid_new_window(Gamep /*g*/, std::string name);
[[nodiscard]] Widp wid_new_vert_scroll_bar(Gamep /*g*/, Widp parent, std::string name, Widp scrollbar_owner);
...
[[nodiscard]] bool wid_scroll_trough_mouse_motion(Gamep /*g*/, Widp w, int x, int y, int relx, int rely, int wheelx, int /*wheely*/);
