...
[[nodiscard]] Widp wid_new_container(Gamep, Widp /*parent*/, std::string name);
...
[[nodiscard]] bool wid_is_always_hidden(Widp);
[[nodiscard]] bool wid_is_hidden(Widp);
[[nodiscard]] bool wid_is_visible(Widp);
...
[[nodiscard]] bool wid_scroll_trough_mouse_motion(Gamep, Widp w, int x, int y, int relx, int rely, int wheelx,
                                                  int /*wheely*/);
[[nodiscard]] bool wid_some_recent_event_occurred(void);
void               wid_destroy_in(Gamep, Widp w, uint32_t ms);
void               wid_destroy_nodelay(Gamep, Widp               */*wp*/);
void               wid_destroy_ptr_in(Gamep, Widp *w, uint32_t ms);
void               wid_destroy(Gamep, Widp               */*wp*/);
...
void               wid_key_down(Gamep, const struct SDL_Keysym               */*key*/, int x, int y);
void               wid_key_up(Gamep, const struct SDL_Keysym               */*key*/, int x, int y);
void               wid_lower(Gamep, Widp /*w_in*/);
...
void               wid_mouse_hide(Gamep, int /*value*/);
...
void               wid_raise(Gamep, Widp /*w_in*/);
...
void               wid_set_debug(Widp, uint8_t /*val*/);
...
void               wid_set_ignore_events(Widp, uint8_t /*val*/);
void               wid_set_ignore_for_mouse_down(Widp, uint8_t /*val*/);
void               wid_set_ignore_scroll_events(Widp, uint8_t /*val*/);
...
void               wid_set_name(Widp, std::string /*name*/);
...
void               wid_set_text_max_len(Widp, size_t /*max_len*/);
...
void               wid_set_text(Widp, std::string /*text*/);
