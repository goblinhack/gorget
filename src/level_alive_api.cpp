...
auto level_alive_is_attackable_by_player(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_attackable_by_player, p);
}

auto level_alive_is_attackable_by_monst(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_attackable_by_monst, p);
}

auto level_alive_is_effect(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_effect, p);
}

auto level_alive_is_effect_attack(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_effect_attack, p);
}

auto level_alive_is_effect_blood(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
...
auto level_alive_is_hit_when_dead(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_hit_when_dead, p);
}

auto level_alive_is_able_to_fire_projectiles(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_able_to_fire_projectiles, p);
}

auto level_alive_is_blitzhound(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
...
auto level_alive_is_grouped_thing(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_grouped_thing, p);
}

auto level_alive_is_able_to_see_360_degrees(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_able_to_see_360_degrees, p);
}

auto level_alive_is_able_to_see_180_degrees(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_able_to_see_180_degrees, p);
}

auto level_alive_is_able_to_lunge(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
  return level_alive(g, v, l, is_able_to_lunge, p);
}

auto level_alive_is_obs_to_paths(Gamep g, Levelsp v, Levelp l, const spoint &p) -> Thingp
{
  TRACE_DEBUG();
