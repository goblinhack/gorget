...
// begin sort marker1 {
[[nodiscard]] bool player_check_if_target_needs_move_confirm(Gamep, Levelsp, Levelp, spoint /*to*/);
[[nodiscard]] bool player_jump(Gamep, Levelsp, Levelp, Thingp /*me*/, spoint /*to*/);
...
[[nodiscard]] bool player_move_to_next(Gamep, Levelsp, Levelp, Thingp /*me*/);
...
[[nodiscard]] bool thing_carry_item(Gamep, Levelsp, Levelp, Thingp /*item*/, Thingp player_or_monst);
[[nodiscard]] bool thing_close(Gamep, Levelsp, Levelp, Thingp /*me*/, Thingp player_or_monst);
[[nodiscard]] bool thing_collect_key(Gamep, Levelsp, Levelp, Thingp /*it*/, Thingp player_or_monst);
[[nodiscard]] bool thing_crush(Gamep, Levelsp, Levelp, Thingp /*it*/, Thingp player_or_monst);
[[nodiscard]] bool thing_debug(Gamep, Levelsp, Levelp, Thingp /*t*/, uint32_t iter_index);
[[nodiscard]] bool thing_drop_item(Gamep, Levelsp, Levelp, Thingp /*item*/, Thingp player_or_monst);
[[nodiscard]] bool thing_inventory_add(Gamep, Levelsp, Levelp, Thingp player_or_monst, Thingp it);
[[nodiscard]] bool thing_inventory_is_empty(Gamep, Levelsp, Levelp, Thingp /*player_or_monst*/);
...
[[nodiscard]] bool thing_jump_to(Gamep, Levelsp, Levelp, Thingp /*t*/, spoint to, bool warn = true);
...
[[nodiscard]] bool thing_on_same_level_as_player(Gamep, Levelsp, Thingp /*t*/);
...
[[nodiscard]] bool thing_pop(Gamep, Levelsp, Thingp /*t*/);
...
[[nodiscard]] bool thing_push(Gamep, Levelsp, Levelp, Thingp /*t*/);
...
[[nodiscard]] bool thing_teleport_handle(Gamep, Levelsp, Levelp, Thingp /*t*/);
[[nodiscard]] bool thing_vision_can_see_tile(Gamep, Levelsp, Levelp, Thingp /*t*/, spoint p);
...
[[nodiscard]] Dmap       *thing_get_dmap(Gamep, Levelsp, Levelp, Thingp /*me*/);
[[nodiscard]] Dmap       *thing_minion_get_mob_dmap(Gamep, Levelsp, Levelp, Thingp /*me*/);
...
[[nodiscard]] Levelp      thing_level(Gamep, Levelsp, Thingp /*t*/);
[[nodiscard]] Levelp      thing_player_level(Gamep);
[[nodiscard]] MonstState  monst_state(Gamep, Levelsp, Levelp, Thingp /*me*/);
...
[[nodiscard]] std::string thing_long_name(Gamep, Levelsp, Levelp, Thingp /*t*/, ThingTextFlags flags = 0);
[[nodiscard]] std::string thing_pluralize_name(Thingp, ThingTextFlags);
[[nodiscard]] std::string thing_short_name(Gamep, Levelsp, Levelp, Thingp /*t*/, ThingTextFlags flags = 0);
[[nodiscard]] std::string thing_the_long_name(Gamep, Levelsp, Levelp, Thingp /*t*/, ThingTextFlags flags = 0);
[[nodiscard]] std::string thing_the_short_name(Gamep, Levelsp, Levelp, Thingp /*t*/, ThingTextFlags flags = 0);
...
[[nodiscard]] ThingExtp   thing_ext_struct(Gamep, Thingp /*t*/);
[[nodiscard]] ThingFovp   thing_fov_struct(Gamep, Thingp /*t*/);
[[nodiscard]] Thingp      immediate_owner(Gamep, Levelsp, Levelp, Thingp /*t*/);
[[nodiscard]] Thingp      thing_alloc(Gamep, Levelsp, Levelp, Tpp tp, spoint /*p*/);
[[nodiscard]] Thingp      thing_and_tp_get_at_safe(Gamep, Levelsp, Levelp, spoint p, int slot, Tpp      */*out*/);
[[nodiscard]] Thingp      thing_and_tp_get_at(Gamep, Levelsp, Levelp, spoint p, int slot, Tpp      */*out*/);
...
[[nodiscard]] Thingp      thing_init(Gamep, Levelsp, Levelp, Tpp /*tp*/, const fpoint      &/*real_at*/);
[[nodiscard]] Thingp      thing_init(Gamep, Levelsp, Levelp, Tpp /*tp*/, const spoint      &/*at*/);
...
[[nodiscard]] Thingp      top_owner(Gamep, Levelsp, Levelp, Thingp /*t*/);
[[nodiscard]] Thingp      wid_get_thing_context(Gamep, Levelsp, Widp, int /*which*/);
...
void monst_state_change(Gamep, Levelsp, Levelp, Thingp /*me*/, MonstState new_state);
void player_collision_handle(Gamep, Levelsp, Levelp, Thingp /*me*/);
void player_fell(Gamep, Levelsp, Levelp, Levelp /*next_level*/, Thingp /*me*/);
...
void player_warp_to_specific_level(Gamep, Levelsp, LevelNum /*level_num*/);
...
void thing_continue_to_burn_check(Gamep, Levelsp, Levelp, Thingp /*t*/);
void thing_damage(Gamep, Levelsp, Levelp, Thingp /*t*/, ThingEvent & /*e*/);
void THING_DBG(Thingp /*t*/, const char *fmt, ...) CHECK_FORMAT_STR(printf, 2, 3);
void thing_dead(Gamep, Levelsp, Levelp, Thingp /*t*/, ThingEvent & /*e*/);
...
void thing_fini(Gamep, Levelsp, Levelp, Thingp /*t*/);
void thing_free(Gamep, Levelsp, Levelp, Thingp t);
void thing_hit_time_step(Gamep, Levelsp, Levelp, Thingp /*t*/, int time_step);
void thing_hot_time_step(Gamep, Levelsp, Levelp, Thingp /*t*/, int time_step);
...
void thing_is_burning_handle(Gamep, Levelsp, Levelp, Thingp /*t*/);
...
void thing_is_dead_handle(Gamep, Levelsp, Levelp, Thingp /*t*/);
...
void thing_level_warp_to_entrance(Gamep, Levelsp, Levelp /*new_level*/, Thingp /*t*/);
void thing_level_warp_to_exit(Gamep, Levelsp, Levelp /*new_level*/, Thingp /*t*/);
...
void thing_monst_event_loop(Gamep, Levelsp, Levelp, Thingp /*me*/);
void thing_monst_tick(Gamep, Levelsp, Levelp, Thingp /*me*/);
...
void thing_sound_play(Gamep, Levelsp, Levelp, Thingp /*t*/, const std::string &alias);
...
void thing_tick_begin(Gamep, Levelsp, Levelp, Thingp /*t*/);
void thing_tick_end(Gamep, Levelsp, Levelp, Thingp /*t*/);
void thing_tick_idle(Gamep, Levelsp, Levelp, Thingp /*t*/);
...
void thing_vision_reset(Gamep, Levelsp, Levelp, Thingp /*t*/);
...
void wid_set_thing_context(Gamep, Levelsp, Widp, Thingp /*t*/);
