...
bool thing_is_obstacle_to_cursor_path(Thingp);
bool thing_is_obstacle_to_explosion(Thingp);
bool thing_is_obstacle_to_falling(Thingp);
bool thing_is_obstacle_to_fire(Thingp);
bool thing_is_obstacle_to_jump_landing(Thingp);
bool thing_is_obstacle_to_jump_over(Thingp);
