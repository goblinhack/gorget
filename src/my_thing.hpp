...
Thingp       thing_and_tp_get_at(Gamep, Levelsp, Levelp, spoint p, int slot, Tpp *);
...
bool   player_move_request(Gamep, bool up, bool down, bool left, bool right, bool fire);
...
bool   thing_is_collision_circle_large(Thingp);
bool   thing_is_collision_circle_small(Thingp);
bool   thing_is_collision_detection_enabled(Thingp);
bool   thing_is_collision_square(Thingp);
...
bool   thing_is_cursor_path_warning(Thingp);
...
bool   thing_is_fireball(Thingp);
bool   thing_is_flesh(Thingp);
...
bool   thing_is_glass(Thingp);
bool   thing_is_gold(Thingp);
...
bool   thing_is_meltable(Thingp);
bool   thing_is_metal(Thingp);
...
bool   thing_is_obs_to_jumping_out_of(Thingp);
bool   thing_is_obs_to_movement(Thingp);
bool   thing_is_obs_to_teleporting_onto(Thingp);
...
bool   thing_is_unused58(Thingp);
bool   thing_is_unused59(Thingp);
bool   thing_is_unused6(Thingp);
bool   thing_is_unused60(Thingp);
bool   thing_is_unused61(Thingp);
bool   thing_is_unused62(Thingp);
bool   thing_is_unused63(Thingp);
bool   thing_is_unused64(Thingp);
bool   thing_is_unused65(Thingp);
bool   thing_is_unused66(Thingp);
bool   thing_is_unused67(Thingp);
bool   thing_is_unused68(Thingp);
bool   thing_is_unused69(Thingp);
bool   thing_is_unused7(Thingp);
bool   thing_is_unused70(Thingp);
bool   thing_is_unused71(Thingp);
bool   thing_is_unused72(Thingp);
bool   thing_is_unused73(Thingp);
bool   thing_is_unused74(Thingp);
bool   thing_is_unused75(Thingp);
...
std::string thing_the_short_name(Gamep, Levelsp, Levelp, Thingp, ThingTextFlags flags = 0);
std::string thing_short_name(Gamep, Levelsp, Levelp, Thingp, ThingTextFlags flags = 0);
