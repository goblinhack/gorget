...
bool thing_is_blit_never_monochrome(Thingp);
...
bool thing_is_door_type_locked(Thingp);
bool thing_is_door_type_secret(Thingp);
bool thing_is_door_type_unlocked(Thingp);
