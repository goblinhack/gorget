...
void wid_inventory_show(Gamep, Levelsp, Levelp, Thingp /*player*/);
...
Widp wid_new_back_button(Gamep, Widp parent, std::string name);
Widp wid_new_menu_button(Gamep, Widp parent, std::string name);
Widp wid_new_save_button(Gamep, Widp parent, std::string name);
Widp wid_new_cancel_button(Gamep, Widp parent, std::string name);
Widp wid_new_green_button(Gamep, Widp parent, std::string name);
Widp wid_new_red_button(Gamep, Widp parent, std::string name);
Widp wid_new_button(Gamep, Widp parent, std::string name);
