...
auto test_load_ghost_no_water() -> bool;
...
auto test_load_monster_door_locked() -> bool;
auto test_load_monster_door_unlocked() -> bool;
auto test_load_monster_maze() -> bool;
auto test_load_monster_mob_leash() -> bool;
auto test_load_monster_secret_door() -> bool;
