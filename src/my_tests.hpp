...
auto test_load_throw_potion_levitation_hard_landing() -> bool;
auto test_load_throw_potion_levitation_soft_landing() -> bool;
auto test_load_throw_potion_levitation() -> bool;
