...
[[nodiscard]] bool        game_is_new_highest_hiscore(Gamep, int score);
[[nodiscard]] bool        game_is_new_hiscore(Gamep, int score);
[[nodiscard]] bool        game_wait_for_tick_to_finish(Gamep, Levelsp, Levelp);
...
[[nodiscard]] bool        game_load(Gamep, const std::string &name);
[[nodiscard]] bool        game_map_zoom_is_full_map_visible(Gamep);
...
[[nodiscard]] bool        game_save(Gamep, const std::string &file_to_save);
[[nodiscard]] const char *game_place_str(Gamep, int score);
[[nodiscard]] GameState   game_state(Gamep);
[[nodiscard]] int         game_map_single_pix_size_get(Gamep);
[[nodiscard]] int         game_map_zoom_def_get(Gamep);
[[nodiscard]] int         game_map_zoom_get(Gamep);
[[nodiscard]] uint32_t    game_tick_get(Gamep, Levelsp);
