...
Levelp game_level_get(Gamep /*g*/, Levelsp /*v*/, LevelNum level_num);
Levelp game_level_populate(Gamep /*g*/, Levelsp /*v*/, LevelNum level_num);
...
bool game_load(Gamep /*g*/, const std::string &name);
...
bool      game_mouse_up(Gamep /*g*/, int x, int y, uint32_t button);
GameState game_state(Gamep /*g*/);
