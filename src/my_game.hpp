...
[[nodiscard]] auto game_level_get(Gamep g, Levelsp v, LevelNum level_num) -> Levelp;
[[nodiscard]] auto game_level_populate(Gamep g, Levelsp v, LevelNum level_num) -> Levelp;
...
[[nodiscard]] auto game_load(Gamep g, const std::string &name) -> bool;
