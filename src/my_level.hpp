...
struct MyIter {
  ...
  MyIter(Gamep, Levelsp /*_v*/, int *iter, const char *func, unsigned short line);
  ~MyIter();
};
...
[[nodiscard]] Thingp                level_alive(Gamep, Levelsp, Levelp, ThingFlag /*f*/, spoint /*p*/);
[[nodiscard]] Thingp                level_alive(Gamep, Levelsp, Levelp, ThingFlag /*f*/, Thingp /*at*/);
[[nodiscard]] Thingp                level_flag(Gamep, Levelsp, Levelp, ThingFlag /*f*/, spoint /*p*/);
[[nodiscard]] Thingp                level_flag(Gamep, Levelsp, Levelp, ThingFlag /*f*/, Thingp /*at*/);
