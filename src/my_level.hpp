...
[[nodiscard]] auto level_is_item_consumable(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me = nullptr) -> Thingp;
...
[[nodiscard]] auto level_alive_is_item_consumable(Gamep g, Levelsp v, Levelp l, const bpoint &p) -> Thingp;
...
[[nodiscard]] auto level_open_is_item_consumable(Gamep g, Levelsp v, Levelp l, const bpoint &p) -> Thingp;
