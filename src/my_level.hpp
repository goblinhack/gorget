...
[[nodiscard]] auto level_is_item_active_when_carried(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me = nullptr) -> Thingp;
...
[[nodiscard]] auto level_alive_is_item_active_when_carried(Gamep g, Levelsp v, Levelp l, const bpoint &p) -> Thingp;
...
[[nodiscard]] auto level_is_item_active_when_carried_bool(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me = nullptr) -> bool;
