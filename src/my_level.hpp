...
[[nodiscard]] auto level_is_noisey(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me = nullptr) -> Thingp;
...
[[nodiscard]] auto level_open_is_noisey(Gamep g, Levelsp v, Levelp l, const bpoint &p) -> Thingp;
...
[[nodiscard]] auto level_is_noisey_bool(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me = nullptr) -> bool;
