...
public:
  ...
  bool is_unused193 {};
  bool is_unused194 {};
  bool is_is_cursor_path_hazard {};
  bool is_is_cursor_path_blocker {};
  bool is_is_obs_wall_or_door {};
...
static Tpidmap tp_is_cursor_path_hazard;
static Tpidmap tp_is_cursor_path_blocker;
static Tpidmap tp_is_obs_wall_or_door;
static Tpidmap tp_able_to_walk_through_walls;
...
void tp_random_dungeon_init(void)
{
  ...
  for (auto &tp : tp_id_map) {
    ...
    if (tp->is_is_cursor_path_hazard) {
      tp_is_cursor_path_hazard.push_back(tp);
    }

    if (tp->is_is_cursor_path_blocker) {
      tp_is_cursor_path_blocker.push_back(tp);
    }

    if (tp->is_is_obs_wall_or_door) {
      tp_is_obs_wall_or_door.push_back(tp);
    }

    if (tp->is_able_to_walk_through_walls) {
      tp_able_to_walk_through_walls.push_back(tp);
    }
...
bool tp_is_is_cursor_path_hazard(Tpp tp) { return tp->is_is_cursor_path_hazard; }
void tp_is_is_cursor_path_hazard_set(Tpp tp, bool val) { tp->is_is_cursor_path_hazard = val; }

bool tp_is_is_cursor_path_blocker(Tpp tp) { return tp->is_is_cursor_path_blocker; }
void tp_is_is_cursor_path_blocker_set(Tpp tp, bool val) { tp->is_is_cursor_path_blocker = val; }

bool tp_is_is_obs_wall_or_door(Tpp tp) { return tp->is_is_obs_wall_or_door; }
void tp_is_is_obs_wall_or_door_set(Tpp tp, bool val) { tp->is_is_obs_wall_or_door = val; }

bool tp_is_able_to_walk_through_walls(Tpp tp) { return tp->is_able_to_walk_through_walls; }
void tp_is_able_to_walk_through_walls_set(Tpp tp, bool val) { tp->is_able_to_walk_through_walls = val; }
