...
bool g_opt_tests_start;             // Start in the main menu
bool g_opt_tests_level_select_menu; // Start in the select menu
bool g_opt_do_room_gen;             // Test room gen
bool g_opt_tests_level_select_gen;  // Test level select gen
bool g_opt_tests_level_gen;         // Test level gen
...
void reset_globals(void)
{
  ...
  g_opt_tests_start             = false;
  g_opt_tests_level_select_menu = false;
  g_opt_do_room_gen             = false;
  g_opt_tests_level_select_gen  = false;
  g_opt_tests_level_gen         = false;
