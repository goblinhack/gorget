...
[[nodiscard]] static auto test_laser_barrel_explosion(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_laser_barrel_explosion() ->  bool // NOLINT
{
  TRACE();

  Testp test = test_load("laser_barrel_explosion");

  // begin sort marker1 {
  test_callback_set(test, test_laser_barrel_explosion);
  // end sort marker1 }
