...
[[nodiscard]] static auto test_potion_levitation_player_move_fail(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_potion_levitation_player_move_fail() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("potion_levitation_player_move_fail");

  // begin sort marker1 {
  test_callback_set(test, test_potion_levitation_player_move_fail);
  // end sort marker1 }
