...
[[nodiscard]] static auto test_projectile_door_locked(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
auto test_load_projectile_door_locked() -> bool // NOLINT
{
  TRACE();
  ...
  // begin sort marker1 {
  test_callback_set(test, test_projectile_door_locked);
  // end sort marker1 }
