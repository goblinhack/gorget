...
[[nodiscard]] static auto test_laser_wall_turns_to_lava(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
auto test_load_laser_wall_turns_to_lava() -> bool // NOLINT
{
  ...
  Testp test = test_load("laser_wall_turns_to_lava");

  // begin sort marker1 {
  test_callback_set(test, test_laser_wall_turns_to_lava);
  // end sort marker1 }
