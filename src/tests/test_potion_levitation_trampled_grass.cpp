...
[[nodiscard]] static auto test_potion_levitation_trampled_grass(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_potion_levitation_trampled_grass() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("potion_levitation_trampled_grass");

  // begin sort marker1 {
  test_callback_set(test, test_potion_levitation_trampled_grass);
  // end sort marker1 }
