...
static bool test_collision_fire_water(Gamep g, Testp t)
{
  TEST_LOG(t, "begin");
  TRACE_AND_INDENT();
...
bool test_load_collision_fire_water(void)
{
  TRACE_NO_INDENT();

  Testp test = test_load("collision_fire_water");

  // begin sort marker1 {
  test_callback_set(test, test_collision_fire_water);
  // end sort marker1 }
