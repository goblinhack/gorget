...
[[nodiscard]] static auto test_wand_border_turns_to_lava(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_projectile_border_turns_to_lava() -> bool // NOLINT
{
  TRACE();
  ...
  // begin sort marker1 {
  test_callback_set(test, test_wand_border_turns_to_lava);
  // end sort marker1 }
