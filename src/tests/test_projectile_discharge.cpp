...
[[nodiscard]] static auto test_projectile_discharge(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
auto test_load_projectile_discharge() -> bool // NOLINT
{
  TRACE();
  ...
  // begin sort marker1 {
  test_callback_set(test, test_projectile_discharge);
  // end sort marker1 }
