...
[[nodiscard]] static auto test_potion_levitation_player_in_steam(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_potion_levitation_player_in_steam() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("potion_levitation_player_in_steam");

  // begin sort marker1 {
  test_callback_set(test, test_potion_levitation_player_in_steam);
  // end sort marker1 }
