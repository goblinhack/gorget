...
[[nodiscard]] static auto test_laser_over_water(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_laser_over_water() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("laser_over_water");

  // begin sort marker1 {
  test_callback_set(test, test_laser_over_water);
  // end sort marker1 }
