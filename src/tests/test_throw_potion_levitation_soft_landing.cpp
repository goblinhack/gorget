...
[[nodiscard]] static auto test_throw_potion_levitation_soft_landing(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_throw_potion_levitation_soft_landing() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("throw_potion_levitation_soft_landing");

  // begin sort marker1 {
  test_callback_set(test, test_throw_potion_levitation_soft_landing);
  // end sort marker1 }
