...
static bool test_collision_mob(Gamep g, Testp t)
{
  TEST_LOG(t, "begin");
  TRACE_AND_INDENT();
...
bool test_load_collision_mob(void)
{
  TRACE_NO_INDENT();

  Testp test = test_load("collision_mob");

  // begin sort marker1 {
  test_callback_set(test, test_collision_mob);
  // end sort marker1 }
