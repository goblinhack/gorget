...
[[nodiscard]] static auto test_laser_door_unlocked(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
auto test_load_laser_door_unlocked() -> bool // NOLINT
{
  TRACE();
  ...
  // begin sort marker1 {
  test_callback_set(test, test_laser_door_unlocked);
  // end sort marker1 }
