...
[[nodiscard]] static auto test_potion_dislocation_bad_luck(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_potion_dislocation_bad_luck() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("potion_dislocation_bad_luck");

  // begin sort marker1 {
  test_callback_set(test, test_potion_dislocation_bad_luck);
  // end sort marker1 }
