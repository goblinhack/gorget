...
[[nodiscard]] static auto test_pot_lev_player_lava(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_pot_lev_player_lava() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("pot_lev_player_lava");

  // begin sort marker1 {
  test_callback_set(test, test_pot_lev_player_lava);
  // end sort marker1 }
