...
[[nodiscard]] static auto test_pot_lev_player_grass(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_pot_lev_player_grass() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("pot_lev_player_grass");

  // begin sort marker1 {
  test_callback_set(test, test_pot_lev_player_grass);
  // end sort marker1 }
