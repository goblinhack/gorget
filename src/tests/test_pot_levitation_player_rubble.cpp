...
[[nodiscard]] static auto test_pot_lev_player_rubble(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_pot_lev_player_rubble() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("pot_lev_player_rubble");

  // begin sort marker1 {
  test_callback_set(test, test_pot_lev_player_rubble);
  // end sort marker1 }
